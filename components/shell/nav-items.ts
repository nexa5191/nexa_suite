...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { key: "connections", href: "/connections", label: "Connections", icon: Plug },
    ],
  },
  {
    label: "Accounting",
    items: [
      {
        key: "ledger", href: "/journal", label: "Ledger & Journals", icon: BookOpen,
        children: [
      ...
      {
        key: "expenses", href: "/petty-cash", label: "Expenses", icon: Coins,
        children: [
      ...
      {
        key: "assets", href: "/assets", label: "Assets & Contracts", icon: Building2,
        children: [
      ...
      {
        key: "period-close", href: "/financial-close", label: "Period Close", icon: Lock,
        children: [
  ...
  },
  {
    ...
    items: [
      {
        key: "gst", href: "/tax", label: "GST", icon: Landmark,
        children: [
      ...
      {
        key: "direct-tax", href: "/tax/tcs", label: "Direct Tax", icon: Percent,
        children: [
      ...
      {
        key: "compliance", href: "/compliance", label: "Compliance", icon: ScrollText,
        children: [
  ...
  },
  {
    ...
    items: [
      ...
      {
        key: "sales", href: "/orders", label: "Sales", icon: ShoppingCart,
        children: [
  ...
  },
  {
    ...
    items: [
      {
        key: "budget-hub", href: "/planning/budget", label: "Budget", icon: Target,
        children: [
      ...
      {
        key: "planning-hub", href: "/planning/saop", label: "Planning", icon: TrendingUp,
        children: [
      ...
      {
        key: "analysis-hub", href: "/analysis/cost-audit", label: "Analysis", icon: PieChart,
        children: [
  ...
  },
  {
    ...
    items: [
      {
        key: "financial-statements", href: "/reports/profit-loss", label: "Financial Statements", icon: TrendingUp,
        children: [
      ...
      {
        key: "management-reports", href: "/reports/explorer", label: "Management Reports", icon: Table2,
        children: [
      ...
      {
        key: "analytics", href: "/reports/dcf", label: "Analytics & Valuation", icon: Activity,
        children: [
  ...
  },
  {
    ...
    items: [
      {
        key: "hr-hub", href: "/hr", label: "HR & People", icon: UserRound,
        children: [
      ...
      {
        key: "payroll-hub", href: "/hr/payroll", label: "Payroll", icon: Banknote,
        children: [
      ...
      {
        key: "time-leave", href: "/hr/attendance", label: "Time & Leave", icon: Clock,
        children: [
...
// Routes that must match exactly (not prefix-match), because sub-paths
// belong to sibling or child nav items rather than the parent.
...
export function isNavActive(pathname: string, href: string) {
  ...
  // /invoicing stays active for the new-invoice builder but not e-invoicing.
